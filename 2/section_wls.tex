...
\paragraph{考察}
出力された係数はほとんど同じなので最適化方法は違っても両者ともに同じ値に近づいていることがわかる。また図\ref{fig:task5_ols}と図\ref{fig:task5_wls}から、OLS と WLS の両方で，$\hat{\theta}_N$ は $N$ を増やすにつれて収束しており、中でもよりもWLS の方が速く収束していることが確認できた。
また，WLS の方が OLS よりも推定誤差共分散が
